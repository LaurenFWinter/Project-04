...
############## ship data
    ...
    golden_princess = Ship(company='Princess Cruise Line', activities='Princess Book Club, Dancing Classes, Nightclub, Minature Golf, Dance Shows, Hot tubs & Pools, Shopping Center')

    costa_atlatica = Ship(company='Costa Cruise Line', ship='Costa Deliziosa', activities='4D Cinema, Casino, Grand Bar with dance floor, Pool deck with retractable glass roofand giant screen, Library, Virtual World, Squok Club, Children’s pool, Theatre on three levels, Disco, Internet Point, Shopping Center')

    carnival_panorama = Ship(company='Carnival Cruise Line', ship='Carnival Panorama', activities='Limelight Lounge, FunHub Internet room, Clubhouse and Bar, Thrill Theatre 5D cinema room, Circle C kids club lounge, Club O2 teens club lounge, Warehouse Video Arcade, BlueIguana Tequila Bar poolside Mexican bar')

    seabourn_ovation = Ship(company='Seabourn Cruise Line', ship='Seabourn Ovation', activities='Living room, The Casino, The Club lounge, Whirlpool, Card Room, 3 duty-free shops, The Coffee Bar, Patio Pool, Sky Bar, The “Spa at Seabourn”, Fitness Center, Observation Bar')

    seven_seas_navigator = Ship(company='Seven Seas Cruise Line', ship='Navigator', activities='Signature cocktails bar with grand piano, Library, Coffee Connection, Smoking lounge with comfortable leather armchairs; offers hand-rolled Cuban cigars, Card Room / Conference Room, Stars Lounge disco nightclub, The Boutique duty-free shopping arcade, Casino, The Top Deck Power Walking/Jogging Track')

    msc_meraviglia = Ship(company='MSC Cruise Line', ship='Meraviglia', activities='Boutique and Accessories Shop, Casino, Art Lounge and Bar, Solarium adults-only relaxation area, Main Pool area, Sports and kids facilities, Piano Lounge and Bar, 4D Cinema, F1 car simulator, Flight Simulator')

    disney_dream = Ship(company='Disney Cruise Line', ship='Dream', activities='Buena Vista Theatre, Shutters PhotoShop photographic services, Vista Cafe for specialty coffees and teas, D Lounge Bar & Nightclub, Evolution Disco & Nightclub, Pink adults-only champagne bar, Vibe Disco & Club Lounge teens only, It’s A Small World Nursery, Dream’s Oceaneer Club kids 3-12 years, Senses Spa & Fitness Complex, Frozone Treats, Donald’s Pool, Mickey’s Pool')

    royal_caribbean_harmony_of_the_seas = Ship(company='Royal Caribbean Cruise Line', ship='Harmony Of The Seas', activities='Royal Theater, Indoor ice-skating rink, AquaTheatre pool, Entertainment Place nightclub, The Attic Comedy Club, Jazz Lounge, Art Gallery, Central Park outdoor area with live plants, Casino Royale Card Room, Video Games Arcade, Sports Court, Jogging Track, Rock-climbing Walls')
